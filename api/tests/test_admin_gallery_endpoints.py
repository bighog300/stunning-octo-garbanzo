    ...
    def execute(self, query, params=None):
        ...
        if "FROM app.gallery_moderation_overrides" in sql:
            self._row = {
                ...
                "canonical_website_url": None,
                "canonical_instagram_url": None,
                "canonical_facebook_url": None,
        ...
        if "INSERT INTO app.gallery_moderation_overrides" in sql:
            self._row = {
                ...
                "canonical_phone": params[8],
                "canonical_email": params[9],
                "canonical_website_url": params[10],
                "canonical_instagram_url": params[11],
                "canonical_facebook_url": params[12],
                "moderation_reason": params[13],
                "moderator_notes": params[14],
