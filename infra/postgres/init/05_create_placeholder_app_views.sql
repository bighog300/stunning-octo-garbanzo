...
SELECT
    ...
    NULL::TEXT AS source_domain,
    NULL::TEXT AS source_url,
    NULL::TEXT AS gallery_record_type,
    NULL::TEXT AS phone,
    NULL::TEXT AS email,
    ...
    NULL::TEXT AS canonical_phone,
    NULL::TEXT AS canonical_email,
    NULL::TEXT AS canonical_website_url,
    NULL::TEXT AS canonical_instagram_url,
    NULL::TEXT AS canonical_facebook_url,
    NULL::TEXT AS moderation_reason,
    NULL::TEXT AS moderator_notes,
    NULL::TIMESTAMPTZ AS updated_at,
    NULL::INTEGER AS quality_score,
    ...
    NULL::BOOLEAN AS missing_email,
    NULL::BOOLEAN AS missing_phone,
    NULL::BOOLEAN AS missing_social,
